package com.iamalittle.black_souls_options.common.events;
...
public class RenderWorldLastEvent {
    ...
    public RenderWorldLastEvent(PoseStack matrixStack, float tickDelta, Matrix4f projectionMatrix) {
        ...
        // 添加null检查，如果projectionMatrix为null，则创建一个单位矩阵
        this.projectionMatrix = projectionMatrix != null ? new Matrix4f(projectionMatrix) : new Matrix4f();
